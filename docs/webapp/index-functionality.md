...
- **Lane Transitions**: Recommendation cards can switch directly into the next suggested `CKA` lane
...
2. **Labs Data**
   ...
   - Orders `CKA` free drills by `hands-on`, then `ops-diagnostics`, then `planning-focused`
