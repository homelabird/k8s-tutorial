## Question 2501: Projected ConfigMap and Secret volume diagnostics
...
mkdir -p /tmp/exam/q2501
cat <<'EOF_CHECKLIST' > /tmp/exam/q2501/projected-volume-checklist.txt
...
kubectl get configmap projected-volume-brief -n projectedvolume-lab -o yaml > /tmp/exam/q2501/projected-volume-brief.yaml
```
...
- `/tmp/exam/q2501/projected-volume-checklist.txt` contains the required sections and exact projected-volume troubleshooting commands
- `/tmp/exam/q2501/projected-volume-brief.yaml` exports the repaired manifest
