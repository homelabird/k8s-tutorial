## Question 2401: Static pod manifest and mirror pod diagnostics
...
mkdir -p /tmp/exam/q2401
cat <<'EOF_CHECKLIST' > /tmp/exam/q2401/staticpod-diagnostics-checklist.txt
...
kubectl get configmap staticpod-diagnostics-brief -n staticpod-lab -o yaml > /tmp/exam/q2401/staticpod-diagnostics-brief.yaml
```
...
- `/tmp/exam/q2401/staticpod-diagnostics-checklist.txt` contains the required sections and exact static pod troubleshooting commands
- `/tmp/exam/q2401/staticpod-diagnostics-brief.yaml` exports the repaired manifest
