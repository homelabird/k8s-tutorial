## Question 701: StorageClass and dynamic provisioning diagnostics
...
mkdir -p /tmp/exam/q701
cat <<'EOF_CHECKLIST' > /tmp/exam/q701/dynamic-provisioning-checklist.txt
...
kubectl get configmap dynamic-provisioning-brief -n storageclass-lab -o yaml > /tmp/exam/q701/dynamic-provisioning-brief.yaml
```
...
- `/tmp/exam/q701/dynamic-provisioning-checklist.txt` contains the required sections and exact storage troubleshooting commands
- `/tmp/exam/q701/dynamic-provisioning-brief.yaml` exports the repaired manifest
