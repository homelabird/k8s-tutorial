## Question 1801: PriorityClass and preemption diagnostics
...
mkdir -p /tmp/exam/q1801
cat <<'EOF_CHECKLIST' > /tmp/exam/q1801/priority-diagnostics-checklist.txt
...
kubectl get configmap priority-diagnostics-brief -n priority-lab -o yaml > /tmp/exam/q1801/priority-diagnostics-brief.yaml
```
...
- `/tmp/exam/q1801/priority-diagnostics-checklist.txt` contains the required sections and exact PriorityClass inventory and workload-priority troubleshooting commands
- `/tmp/exam/q1801/priority-diagnostics-brief.yaml` exports the repaired manifest
