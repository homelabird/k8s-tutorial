## Question 1001: DaemonSet rollout and node coverage diagnostics
...
cat <<'EOF_CHECKLIST' > /tmp/exam/q1001/daemonset-rollout-checklist.txt
DaemonSet Inventory
...
kubectl get configmap daemonset-rollout-brief -n daemonset-lab -o yaml > /tmp/exam/q1001/daemonset-rollout-brief.yaml
```
...
- `/tmp/exam/q1001/daemonset-rollout-checklist.txt` contains the required sections and exact DaemonSet, node coverage, and rollout review commands
- `/tmp/exam/q1001/daemonset-rollout-brief.yaml` exports the repaired manifest
