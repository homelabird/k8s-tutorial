...
- `cka-2026-single-domain-contract-smoke.sh`
  - Verifies that the promoted single-domain `cka-006` through `cka-048` drills stay aligned across the runner inventory, facilitator `labs.json`, facilitator README listing, and promoted template docs without starting the Podman stack.
...
- `run-cka-2026-single-domain-drills.sh`
  - Runs the promoted single-domain `cka-006` through `cka-048` drills sequentially, resetting the local Podman stack and solving each drill through the shared jumphost before evaluation.
...
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-032
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-033
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-034
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-038
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-039
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-040
...
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-045
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-046
./scripts/verify/run-cka-2026-single-domain-drills.sh cka-048
```
