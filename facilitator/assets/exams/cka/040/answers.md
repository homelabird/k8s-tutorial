## Question 1: PersistentVolume reclaim policy and claimRef diagnostics
...
- `/tmp/exam/q1/reclaim-diagnostics-checklist.txt` contains the required sections and exact PVC inventory and PV troubleshooting commands
- `/tmp/exam/q1/reclaim-diagnostics-brief.yaml` exports the repaired manifest
