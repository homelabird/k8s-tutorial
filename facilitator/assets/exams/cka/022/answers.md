# CKA 2026 Single Domain Drill - kubelet and node NotReady troubleshooting

## Question 1: kubelet and node NotReady troubleshooting
...
- `/tmp/exam/q1/node-notready-checklist.txt` contains the required sections and exact troubleshooting commands
- `/tmp/exam/q1/node-recovery-brief.yaml` exports the repaired manifest
