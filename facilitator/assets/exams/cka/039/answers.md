## Question 1: ServiceAccount imagePullSecrets and private registry diagnostics
...
- `/tmp/exam/q1/pull-auth-diagnostics-checklist.txt` contains the required sections and exact deployment inventory and registry-auth troubleshooting commands
- `/tmp/exam/q1/pull-auth-diagnostics-brief.yaml` exports the repaired manifest
