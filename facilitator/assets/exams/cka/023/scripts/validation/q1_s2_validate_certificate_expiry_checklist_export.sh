...
EXPORT_FILE="/tmp/exam/q1/certificate-expiry-checklist.txt"
...
grep -Fq 'sudo cp /etc/kubernetes/manifests/kube-apiserver.yaml /tmp/exam/q1/kube-apiserver.yaml.bak' "$EXPORT_FILE" || { echo "Checklist missing manifest backup step"; exit 1; }
