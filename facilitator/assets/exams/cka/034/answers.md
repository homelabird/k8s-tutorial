## Question 1: Pod anti-affinity and topology spread diagnostics
...
- `/tmp/exam/q1/placement-diagnostics-checklist.txt` contains the required sections and exact deployment inventory and placement troubleshooting commands
- `/tmp/exam/q1/placement-diagnostics-brief.yaml` exports the repaired manifest
