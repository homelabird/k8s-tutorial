# CKA 2026 Single Domain Drill - scheduler and controller-manager troubleshooting

## Question 1: repair the control-plane recovery brief and export the checklist
...
- `/tmp/exam/q1/control-plane-checklist.txt` contains the required sections and exact troubleshooting commands
- `/tmp/exam/q1/component-repair-brief.yaml` exports the repaired manifest
