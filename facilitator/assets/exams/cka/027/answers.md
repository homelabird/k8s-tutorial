# CKA 2026 Single Domain Drill - PodDisruptionBudget and drain planning

## Question 1: PodDisruptionBudget and drain planning
...
- `/tmp/exam/q1/disruption-planning-checklist.txt` contains the required sections and exact disruption-planning commands
- `/tmp/exam/q1/disruption-planning-brief.yaml` exports the repaired manifest
