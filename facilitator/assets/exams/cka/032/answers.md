## Question 1: Readiness, liveness, and startupProbe diagnostics
...
- `/tmp/exam/q1/probe-diagnostics-checklist.txt` contains the required sections and exact deployment inventory and probe troubleshooting commands
- `/tmp/exam/q1/probe-diagnostics-brief.yaml` exports the repaired manifest
