## Question 1: Pod securityContext and fsGroup diagnostics
...
- `/tmp/exam/q1/securitycontext-diagnostics-checklist.txt` contains the required sections and exact deployment inventory and workload security troubleshooting commands
- `/tmp/exam/q1/securitycontext-diagnostics-brief.yaml` exports the repaired manifest
