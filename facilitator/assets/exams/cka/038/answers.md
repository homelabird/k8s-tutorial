## Question 1: Pod resource requests, limits, and QoS diagnostics
...
- `/tmp/exam/q1/qos-diagnostics-checklist.txt` contains the required sections and exact deployment inventory and QoS troubleshooting commands
- `/tmp/exam/q1/qos-diagnostics-brief.yaml` exports the repaired manifest
